...
let rep_lambda var : Doc.doc =
  Format.dprintf {|\lambda{%s}.\,@,|} var
let rep_appl : Doc.doc = Format.dprintf {|\,@,|}
...
let rep_eq  : Doc.doc = Format.dprintf "@<2>%s@," {|\mathbin{\doteq}|}
let rep_and : Doc.doc = Format.dprintf "@<2>%s@," {|\mathbin{\land}|}
let rep_top : Doc.doc = Format.dprintf "@<2>%s@," {|\top|}
let rep_or  : Doc.doc = Format.dprintf "@<2>%s@," {|\mathbin{\lor}|}
let rep_bot : Doc.doc = Format.dprintf "@<2>%s@," {|\bot|}
let rep_imp : Doc.doc = Format.dprintf "@<2>%s@," {|\mathbin{\Rightarrow}|}
